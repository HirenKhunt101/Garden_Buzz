                ...
                <div className="home__container container grid">
                    ...
                    <div className="home__social">
                        ...
                        <div className="home__social-links">
                            ...
                            <a href="https://youtube.com/" target="_blank" className="home__social-link">
            ...
            <section className="product section container" id="products">
                ...
                <div className="product__container grid">
                    <article className="product__card">
                        ...
                        <img src={require('./product1.png')} alt="" className="product__img"/>
                    ...
                    <article className="product__card">
                        ...
                        <img src={require('./product2.png')} alt="" className="product__img"/>
                    ...
                    <article className="product__card">
                        ...
                        <img src={require('./product3.png')} alt="" className="product__img"/>
                    ...
                    <article className="product__card">
                        ...
                        <img src={require('./product4.png')} alt="" className="product__img"/>
                    ...
                    <article className="product__card">
                        ...
                        <img src={require('./product5.png')} alt="" className="product__img"/>
                    ...
                    <article className="product__card">
                        ...
                        <img src={require('./product6.png')} alt="" className="product__img"/>
                ...
                <div className="contact__container grid">
                    <div className="contact__box">
                        <h2 className="section__title">
                            Reach out to us today <br></br> via any of the given <br></br> information </h2>
